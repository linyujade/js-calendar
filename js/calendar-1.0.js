...
(function ($) {
    ...
    $.calendar = {
        ...
        appendCalendarPanel: function () {
            ...
            if (!(calPanel && calPanel.length)) {
                ...
                + '        <span class="' + CALENDAR_HOLIDAY_CLASS + '">' + SUNDAY_LANG + '</span>'
                + '        <span>' + MONDAY_LANG + '</span>'
                + '        <span>' + TUESDAY_LANG + '</span>'
                + '        <span>' + WEDNESDAY_LANG + '</span>'
                + '        <span>' + THURSDAY_LANG + '</span>'
                + '        <span>' + FRIDAY_LANG + '</span>'
                + '        <span class="' + CALENDAR_HOLIDAY_CLASS + '">' + SATURDAY_LANG + '</span>'
                + '    </div>'
                + '</div>';
                $('body').append(html);
        ...
        isValidDate: function (date) {
            var options = $curInputControl ? $curInputControl.options : $options;
    ...
    function showCalender() {
        ...
        // 把对应的可选信息赋给当前的日期对象
        $curInputControl.options = arguments.length ? arguments[0].data.options : $options;
